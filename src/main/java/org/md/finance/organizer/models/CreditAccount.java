...
public class CreditAccount extends AbstractAccount {
    ...
    /**
     * Credits account with a payment. If payments exceeds the amount of 
     * account balance, excess funds are returned. Otherwise, 0 returned.
    ...
    /**
     * Mimics the abstract classes method, determine the interest accrued by
     * an account over a one month period, but with no parameter.
     * @param d double amount in which account balance is to be changed
     * @return interest accrued in the account over a month if the balance of
     *  of the account was changed by d amount
     */
