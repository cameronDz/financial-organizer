...
public class BillPriortizer {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("\n\n" + "=======================Account information" + 
                "========================\n"); 
        System.out.print( formatString( "Account name", "Balance",
                "Rate", "Yr. Int", "Min. Pay") + "\n" );
        // loops through accounts index 
        for( int i = 0; i < accounts.size(); i++) {
            String s = formatStringDouble( accounts.get(i), balances.get(i), 
                    rates.get(i), interests.get(i), monthly.get(i) ); 
            System.out.print(s + "\n");
     ...
     * used when doubles have not been converted to strings
    ...
    /**
     * Figure out and print yearly account balance after minimum monthly 
     * payments 
     * @param b account balance
     * @param r account interest rate
     * @param m account minimum monthly payment
